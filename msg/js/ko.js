...
Blockly.Msg.MATH_SINGLE_TOOLTIP_LOG = "어떤 수의, 자연로그(natural logarithm) 값을 돌려줍니다.(밑 e, 예시 log e x)";
Blockly.Msg.MATH_SINGLE_TOOLTIP_LOG10 = "어떤 수의, 기본로그(logarithm) 값을 돌려줍니다.(밑 10, 예시 log 10 x)";
Blockly.Msg.MATH_SINGLE_TOOLTIP_LOG2 = "어떤 수의, 밑이2인 로그(logarithm) 값을 돌려줍니다.(밑 2, 예시 log 2 x)";
Blockly.Msg.MATH_SINGLE_TOOLTIP_NEG = "음(-)/양(+), 부호를 반대로 하여 값을 돌려줍니다.";
Blockly.Msg.MATH_SINGLE_TOOLTIP_POW = "밑(base)의, 거듭제곱(power) 값을 돌려줍니다.";
...
Blockly.Msg.VARIABLES_SET_TAIL = "를 다음 값으로 바꾸기";
Blockly.Msg.VARIABLES_SET_TITLE = "바꾸기";
...
Blockly.Msg.STDLIB_CONVERT_DOUBLE = '실수';
Blockly.Msg.STDLIB_CONVERT_TOOLTIP = '문자를 해당 type으로 변환합니다.';
Blockly.Msg.STDLIB_CONVERT_HELPURL = 'https://ko.wikipedia.org/wiki/Stdlib.h';
Blockly.Msg.STDLIB_RAND_TITLE = '임의의 수 %1';
Blockly.Msg.STDLIB_RAND_TOOLTIP = '임의의 수를 할당합니다.';
Blockly.Msg.STDLIB_RAND_HELPURL = 'https://ko.wikipedia.org/wiki/Stdlib.h';
Blockly.Msg.STDLIB_RANDSCOPE_TITLE = "범위:%1~%2";
Blockly.Msg.STDLIB_RANDSCOPE_TOOLTIP = '임의의 수를 할당할 범위를 지정합니다.';
Blockly.Msg.STDLIB_RANDSCOPE_HELPURL = 'https://ko.wikipedia.org/wiki/Stdlib.h';
...
Blockly.Msg.STDLIB_MALLOC_HELPURL = 'https://ko.wikipedia.org/wiki/%EB%8F%99%EC%A0%81_%EB%A9%94%EB%AA%A8%EB%A6%AC_%ED%95%A0%EB%8B%B9';
Blockly.Msg.STDLIB_SIZEOFFORMALLOC_TITLE = '%1의 크기';
...
Blockly.Msg.STDLIB_FREE_HELPURL = 'https://ko.wikipedia.org/wiki/동적_메모리_할당';
Blockly.Msg.STDLIB_EXIT_TITLE = '종료 %1';
Blockly.Msg.STDLIB_EXIT_SUCCESS = '성공';
Blockly.Msg.STDLIB_EXIT_FAILURE = '실패';
Blockly.Msg.STDLIB_EXIT_TOOLTIP = '함수를 종료합니다.';
Blockly.Msg.STDLIB_EXIT_HELPURL = 'https://ko.wikipedia.org/wiki/Exit_(%EB%AA%85%EB%A0%B9%EC%96%B4)';
Blockly.Msg.MATH_SIN_TITLE = 'sin %1'; // not use
Blockly.Msg.MATH_COS_TITLE = 'cos %1'; // not use
Blockly.Msg.MATH_TAN_TITLE = 'tan %1'; // not use
Blockly.Msg.MATH_POW_TITLE = '%1의 %2 제곱';//'%1의 %2 제곱';
...
Blockly.Msg.VARIABLES_DECLARE_TITLE = '변수, 타입';
...
Blockly.Msg.DEFINE_DECLARE_TITLE = '매크로';
Blockly.Msg.DEFINE_DECLARE_INIT = '값';
