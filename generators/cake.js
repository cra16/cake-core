...
Blockly.cake.addReservedWords(
    ...
    // https://developer.mozilla.org/en/cake/Reference/Reserved_Words
    'break,case,catch,continue,debugger,default,delete,do,else,finally,for,function,if,in,instanceof,new,return,switch,this,throw,try,typeof,var,void,while,with,' +
    'class,enum,export,extends,import,super,implements,interface,let,package,private,protected,public,static,yield,' +
    'const,null,true,false,' +
    // https://developer.mozilla.org/en/cake/Reference/Global_Objects
...
Blockly.cake.ORDER_MEMBER = 1;         // . []
Blockly.cake.ORDER_NEW = 1;            // new
Blockly.cake.ORDER_FUNCTION_CALL = 2;  // ()
Blockly.cake.ORDER_INCREMENT = 3;      // ++
Blockly.cake.ORDER_DECREMENT = 3;      // --
Blockly.cake.ORDER_LOGICAL_NOT = 4;    // !
Blockly.cake.ORDER_BITWISE_NOT = 4;    // ~
Blockly.cake.ORDER_UNARY_PLUS = 4;     // +
Blockly.cake.ORDER_UNARY_NEGATION = 4; // -
Blockly.cake.ORDER_TYPEOF = 4;         // typeof
Blockly.cake.ORDER_VOID = 4;           // void
Blockly.cake.ORDER_DELETE = 4;         // delete
