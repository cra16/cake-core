...
goog.provide('Blockly.FieldVariableDefine');
...
goog.inherits(Blockly.FieldVariableDefine, Blockly.FieldDropdown);
 ...
 */
Blockly.FieldVariableDefine.prototype.clone = function() {
  return new Blockly.FieldVariableDefine(this.getValue(), this.changeHandler_);
};
 ...
 */
Blockly.FieldVariableDefine.prototype.getValue = function() {
  return this.getText();
};
 ...
 */
Blockly.FieldVariableDefine.prototype.setValue = function(text) {
  this.value_ = text;
  this.setText(text);
};
