...
mazepage.messages = function(opt_data, opt_ignored, opt_ijData) {
  return apps.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Maze_moveForward">handroso</span><span id="Maze_turnLeft">hihodina ankavia</span><span id="Maze_turnRight">hihodina ankavanana</span><span id="Maze_doCode">atao</span><span id="Maze_elseCode">rahatsyizany</span><span id="Maze_helpIfElse">Hanaoo zavatra iray na iray hafa ny bolongana Raha-rahatsyizany</span><span id="Maze_pathAhead">raha lalana eo aloha</span><span id="Maze_pathLeft">raha lalana miankavia</span><span id="Maze_pathRight">raha lalana miankavanana</span><span id="Maze_repeatUntil">avereno hatramy</span><span id="Maze_moveForwardTooltip">Moves the player forward one space.</span><span id="Maze_turnTooltip">Turns the player left or right by 90 degrees.</span><span id="Maze_ifTooltip">If there is a path in the specified direction, then do some actions.</span><span id="Maze_ifelseTooltip">If there is a path in the specified direction, then do the first block of actions.  Otherwise, do the second block of actions.</span><span id="Maze_whileTooltip">Repeat the enclosed actions until finish point is reached.</span><span id="Maze_capacity0">bolongana %0 sisa.</span><span id="Maze_capacity1">Bolongana %1 sisa.</span><span id="Maze_capacity2">Bolongana %1 sisa.</span><span id="Maze_nextLevel">Congratulations! Are you ready to proceed to level %1?</span><span id="Maze_finalLevel">Congratulations! You have solved the final level.</span></div>';
};


mazepage.start = function(opt_data, opt_ignored, opt_ijData) {
  var output = mazepage.messages(null, null, opt_ijData) + '<table width="100%"><tr><td><h1><span id="title"><a href="../index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '">Blockly</a> : Labirainty</span> &nbsp; ';
