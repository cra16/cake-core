...
mazepage.messages = function(opt_data, opt_ignored, opt_ijData) {
  return apps.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Maze_moveForward">ba ukeuë</span><span id="Maze_turnLeft">Puta wië</span><span id="Maze_turnRight">puta uneun</span><span id="Maze_doCode">peubuët</span><span id="Maze_elseCode">meunghan</span><span id="Maze_helpIfElse">Meunyoë-la\'én block ka neupeugot saboh hai atawa la\'én</span><span id="Maze_pathAhead">meunyoë na leupah ukeuë</span><span id="Maze_pathLeft">meunyoë na leupah uwië</span><span id="Maze_pathRight">meunyoë na leupah u uneun</span><span id="Maze_repeatUntil">neuulang sampoë</span><span id="Maze_moveForwardTooltip">Pinah ureuëng meu\'èn saboh kutak ukeuë.</span><span id="Maze_turnTooltip">Peulingka ureuëng meu\'en 90 derjat u wië atawa uneun.</span><span id="Maze_ifTooltip">If there is a path in the specified direction, then do some actions.</span><span id="Maze_ifelseTooltip">If there is a path in the specified direction, then do the first block of actions.  Otherwise, do the second block of actions.</span><span id="Maze_whileTooltip">Repeat the enclosed actions until finish point is reached.</span><span id="Maze_capacity0">You have %0 blocks left.</span><span id="Maze_capacity1">You have %1 block left.</span><span id="Maze_capacity2">You have %2 blocks left.</span><span id="Maze_nextLevel">Congratulations! Are you ready to proceed to level %1?</span><span id="Maze_finalLevel">Congratulations! You have solved the final level.</span></div>';
};


mazepage.start = function(opt_data, opt_ignored, opt_ijData) {
  var output = mazepage.messages(null, null, opt_ijData) + '<table width="100%"><tr><td><h1><span id="title"><a href="../index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '">Teutheun</a> : Pageuë peusisat</span> &nbsp; ';
