...
codepage.toolbox = function(opt_data, opt_ignored, opt_ijData) {
  return '<xml id="toolbox" style="display: none"><category name="Variables" custom="VARIABLE"></category><category name="Loops"><block type="loop_while"></block><block type="loop_dowhile"></block><block type="loop_for"></block></category><category name="Logic"><block type="logic_ifelse"></block><block type="logic_switch"></block></category><category name="Function"><block type="logic_ifelse"></block><block type="logic_switch"></block></category><category name="Library"><category name="Stdio"><block type="library_func_paren"></block><block type="library_stdio_printf"><value name="TEXT"><block type="library_func_paren"></block></value></block><block type="library_stdio_scanf"><value name="TEXT"><block type="library_func_paren"></block></value></block></category><category name="Stdlib"><block type="library_func_paren"></block><block type="library_stdlib_rand"></block><block type="library_stdlib_exit"></block></category><category name="Math"><block type="library_func_paren"></block><block type="library_math_sin"></block><block type="library_math_cos"></block><block type="library_math_tan"></block></category></category></xml>';
};
