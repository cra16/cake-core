...
codepage.toolbox = function(opt_data, opt_ignored, opt_ijData) {
  return '<xml id="toolbox" style="display: none"><category name="Variable"><block type="var_array"></block><block type="var_integer"></block><block type="var_realnumber"></block><block type="var_character"></block><block type="var_constant"></block></category><category name="Loop"><block type="loop_while"></block><block type="loop_dowhile"></block><block type="loop_for"></block></category><category name="Logic"><block type="logic_ifelse"></block><block type="logic_switch"></block></category><category name="Function"><block type="logic_ifelse"></block><block type="logic_switch"></block></category><category name="Library"><category name="Stdio"><block type="stdio_printf"></block><block type="stdio_scanf"></block></category><category name="Stdlib"><block type="stdlib_rand"></block><block type="stdlib_exit"></block></category><category name="Math"><block type="math_sin"></block><block type="math_cos"></block><block type="math_tan"></block></category></category></xml>';
};
