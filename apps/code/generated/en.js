...
codepage.toolbox = function(opt_data, opt_ignored, opt_ijData) {
  return '<xml id="toolbox" style="display: none"><category name="Variables" custom="VARIABLE"><block type="cake_var_array"></block><block type="cake_var_integer"></block><block type="cake_var_realnumber"></block><block type="cake_var_character"></block><block type="cake_var_constant"></block></category><category name="Loops"><block type="cake_loop_while"></block><block type="cake_loop_dowhile"></block><block type="cake_loop_for"></block></category><category name="Logic"><block type="cake_logic_ifelse"></block><block type="cake_logic_switch"></block></category><category name="Function"><block type="cake_logic_ifelse"></block><block type="cake_logic_switch"></block></category><category name="Library"><category name="Stdio"><block type="cake_func_paren"></block><block type="cake_stdio_printf"></block><block type="cake_stdio_scanf"></block></category><category name="Stdlib"><block type="cake_func_paren"></block><block type="cake_stdlib_rand"></block><block type="cake_stdlib_exit"></block></category><category name="Math"><block type="cake_func_paren"></block><block type="cake_math_sin"></block><block type="cake_math_cos"></block><block type="cake_math_tan"></block></category></category></xml>';
};
