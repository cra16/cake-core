...
Blockly.Blocks['library_math_abs'] = {
    init: function() {
        ...
        this.interpolateMsg(Blockly.Msg.MATH_ABS_TITLE,
            ['VAR', ['Number', 'INT', 'NEGATIVE', 'Variable', 'VAR_INT', 'VAR_UNINT', 'DOUBLE', 'VAR_FLOAT', 'VAR_DOUBLE', 'Aster'], Blockly.ALIGN_RIGHT],
            Blockly.ALIGN_RIGHT);
        this.setInputsInline(true);
...
Blockly.Blocks['library_math_pow'] = {
    init: function() {
        ...
        this.interpolateMsg(Blockly.Msg.MATH_POW_TITLE,
            ['BASE', ['Number', 'INT', 'NEGATIVE', 'Variable', 'VAR_INT', 'VAR_UNINT', 'DOUBLE', 'VAR_FLOAT', 'VAR_DOUBLE', 'Aster'], Blockly.ALIGN_RIGHT],
            ['EXPO', ['Number', 'INT', 'NEGATIVE', 'Variable', 'VAR_INT', 'VAR_UNINT', 'DOUBLE', 'VAR_FLOAT', 'VAR_DOUBLE', 'Aster'], Blockly.ALIGN_RIGHT],
            Blockly.ALIGN_RIGHT);
        this.setInputsInline(true);
...
Blockly.Blocks['library_math_numcompare'] = {
    init: function() {
        ...
        this.interpolateMsg(Blockly.Msg.MATH_NUMCOMPARE_TITLE,
            ['VAR1', ['Number', 'INT', 'NEGATIVE', 'Variable', 'VAR_INT', 'VAR_UNINT', 'DOUBLE', 'VAR_FLOAT', 'VAR_DOUBLE', 'Aster'], Blockly.ALIGN_RIGHT],
            ['VAR2', ['Number', 'INT', 'NEGATIVE', 'Variable', 'VAR_INT', 'VAR_UNINT', 'DOUBLE', 'VAR_FLOAT', 'VAR_DOUBLE', 'Aster'], Blockly.ALIGN_RIGHT],
            ['CONDITIONS', new Blockly.FieldDropdown(CONDITION)],
            Blockly.ALIGN_RIGHT);
        this.setInputsInline(true);
