...
Blockly.Blocks['structure_declare'] = {
  ...
  init: function() {
    ...
    this.interpolateMsg(
      ...
      Blockly.Msg.STRUCTURE_DECLARE_TALE + ' %2', ['TYPES', new Blockly.FieldStructure('-Type-', null)], ['NAME', new Blockly.FieldTextInput(name, Blockly.Procedures.rename), Blockly.ALIGN_RIGHT],
      Blockly.ALIGN_RIGHT);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
